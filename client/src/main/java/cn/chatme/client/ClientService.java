...
import cn.chatme.remote.RecoverReceiver;
...
import cn.chatme.model.ClientState;
...
import cn.chatme.model.NullGroupMember;
import cn.chatme.model.ProtoBurnMessageInfo;
import cn.chatme.model.ProtoChannelInfo;
import cn.chatme.model.ProtoChannelMenu;
import cn.chatme.model.ProtoChatRoomInfo;
import cn.chatme.model.ProtoChatRoomMembersInfo;
import cn.chatme.model.ProtoConversationInfo;
import cn.chatme.model.ProtoConversationSearchresult;
import cn.chatme.model.ProtoFileRecord;
import cn.chatme.model.ProtoFriend;
import cn.chatme.model.ProtoFriendRequest;
import cn.chatme.model.ProtoGroupInfo;
import cn.chatme.model.ProtoGroupMember;
import cn.chatme.model.ProtoGroupSearchResult;
import cn.chatme.model.ProtoMessage;
import cn.chatme.model.ProtoMomentsComment;
import cn.chatme.model.ProtoMomentsFeed;
import cn.chatme.model.ProtoMomentsMedia;
import cn.chatme.model.ProtoOnlineState;
import cn.chatme.model.ProtoReadEntry;
import cn.chatme.model.ProtoSecretChatInfo;
import cn.chatme.model.ProtoUserInfo;
import cn.chatme.model.ProtoUserOnlineState;
...
import cn.chatme.utils.MemoryFileHelper;
import okhttp3.Call;
...
public class ClientService extends Service implements SdtLogic.ICallBack,
    ...
    private class ClientServiceStub extends IRemoteClient.Stub {
        ...
        public long connect(String userName, String userPwd) throws RemoteException {
            ...
            if (mConnectionStatus != ConnectionStatus.ConnectionStatusConnecting
                && mConnectionStatus != ConnectionStatus.ConnectionStatusConnected
                && mConnectionStatus != ConnectionStatus.ConnectionStatusReceiveing) {
                onConnectionStatusChanged(ConnectionStatus.ConnectionStatusConnecting);
            }
        ...
        public void disconnect(boolean disablePush, boolean clearSession) throws RemoteException {
            ...
            onConnectionStatusChanged(ConnectionStatus.ConnectionStatusLogout);
...
//            }
        ...
        public void setForeground(int isForeground) throws RemoteException {
            ...
            if (isForeground == 1 && mConnectionStatus != ConnectionStatus.ConnectionStatusConnected && mConnectionStatus != ConnectionStatus.ConnectionStatusReceiveing) {
                onNetworkChange();
            }
        }
        ...
        public void setConversationTop(int conversationType, String target, int line, int top, IGeneralCallback callback) throws RemoteException {
            setUserSetting(UserSettingScope.ConversationTop, conversationType + "-" + line + "-" + target, top + "", callback);
        }
        ...
        public void setConversationSilent(int conversationType, String target, int line, boolean silent, IGeneralCallback callback) throws RemoteException {
            setUserSetting(UserSettingScope.ConversationSilent, conversationType + "-" + line + "-" + target, silent ? "1" : "0", callback);
        }
        ...
        public void setDeviceToken(String token, int pushType) throws RemoteException {
            ...
            if (mConnectionStatus != ConnectionStatus.ConnectionStatusConnected) {
                return;
            }
        ...
        @Override
        public List<Message> searchMessage(Conversation conversation, String keyword, boolean desc, int limit, int offset, String withUser) throws RemoteException {
...
//            }
    ...
    public void onConnectionStatusChanged(int status) {
        ...
        if (mConnectionStatus == ConnectionStatus.ConnectionStatusConnected && !TextUtils.isEmpty(mBackupDeviceToken)) {
            try {
    ...
    public void onReceiveMessage(List<ProtoMessage> messages, boolean hasMore) {
        if (mConnectionStatus == ConnectionStatus.ConnectionStatusReceiveing && hasMore) {
            return;
        }
        if (messages.isEmpty()) {
            return;
    ...
    private void filterNewMessage(ProtoMessage protoMessage) {
        if (protoMessage.getContent().getType() == MessageContentType.ContentType_Mark_Unread_Sync && userId != null && userId.equals(protoMessage.getFrom())) {
            Message msg = convertProtoMessage(protoMessage);
