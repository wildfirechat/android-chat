...
@ContentTag(type = MessageContentType.ContentType_MODIFY_GROUP_SETTINGS, flag = PersistFlag.No_Persist)
public class ModifyGroupSettingsNotificationContent extends GroupNotificationMessageContent {
    ...
    public static final Parcelable.Creator<ModifyGroupSettingsNotificationContent> CREATOR = new Parcelable.Creator<ModifyGroupSettingsNotificationContent>() {
        @Override
