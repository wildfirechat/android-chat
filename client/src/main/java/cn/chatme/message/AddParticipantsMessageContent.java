...
@ContentTag(type = MessageContentType.ContentType_Call_Add_Participant, flag = PersistFlag.Persist)
public class AddParticipantsMessageContent extends NotificationMessageContent {
    ...
    public static final Parcelable.Creator<AddParticipantsMessageContent> CREATOR = new Parcelable.Creator<AddParticipantsMessageContent>() {
        @Override
