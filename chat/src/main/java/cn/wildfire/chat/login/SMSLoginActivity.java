package cn.wildfire.chat.login;
...
import cn.wildfire.chat.login.model.LoginResult;
import cn.wildfire.chat.main.MainActivity;
import cn.wildfire.chat.net.OKHttpHelper;
import cn.wildfire.chat.net.SimpleCallback;
import cn.wildfire.chat.net.base.StatusResult;
...
public class SMSLoginActivity extends WfcBaseActivity {
    ...
    void login() {
        ...
        String url = "http://" + Config.INDEPENDENT_APP_SERVER_HOST + ":" + Config.INDEPENDENT_APP_SERVER_PORT + "/login";
    ...
    void requestAuthCode() {
        ...
        String phoneNumber = phoneNumberEditText.getText().toString().trim();
        String url = "http://" + Config.INDEPENDENT_APP_SERVER_HOST + ":" + Config.INDEPENDENT_APP_SERVER_PORT + "/send_code";
        Map<String, String> params = new HashMap<>();
        params.put("mobile", phoneNumber);
