...
/**
 * 字体大小设置页。参考微信，通过 SeekBar 拖动选择字体缩放级别，并实时预览效果。
 * <p>
 * 手机端装在 {@link FontSizeActivity} 这个空壳里，平板上同一份实现进右栏。
 */
public class FontSizeFragment extends Fragment implements WfcPage {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        return inflater.inflate(R.layout.activity_font_size, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        currentLevelTextView = view.findViewById(R.id.currentLevelTextView);
        previewReceiveTextView = view.findViewById(R.id.previewReceiveTextView);
        previewSendTextView = view.findViewById(R.id.previewSendTextView);
        previewReceivePortraitImageView = view.findViewById(R.id.previewReceivePortraitImageView);
        previewSendPortraitImageView = view.findViewById(R.id.previewSendPortraitImageView);
        standardMarkerTextView = view.findViewById(R.id.standardMarkerTextView);

        entryIndex = FontScaleUtils.getFontScaleIndex(requireContext());
    ...
    public void onPreparePageMenu(Menu menu) {
        ...
        // actionLayout 的自定义 view 不会触发菜单点击回调，需手动设置点击监听
    ...
    private void confirm() {
        ...
        FontScaleUtils.setFontScaleIndex(requireContext(), index);
        restart();
    }
     ...
     * <p>
     * 这里是真的 {@code finish()} 而不是 {@code finishPage()}：CLEAR_TASK 已经把整个任务栈清掉了，
     * 平板上双栏主界面本来就要跟着一起重建。
     */
